...
$sql = "SELECT monedas.*, paises.nombre AS nombrepais, paises.bandera, paises.divisa, e.descripcion AS estado_moneda, f.foto 
    ...
    WHERE monedas.pais NOT LIKE 'es%';";
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0,10,iconv('utf-8','cp1252','Colección de Monedas Extranjeras'),0,0,'C');
        $this->Ln(10);
    }
    ...
    function FancyTable($header, $data, $titulo)
    {
        ...
        // Salto de línea
        $this->Ln(10);
        $this->Cell(0,10,iconv('utf-8','cp1252','MONEDAS EXTRANJERAS'),0,0,'C');
        $this->Ln(10);
